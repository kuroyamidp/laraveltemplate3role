                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{url('/importkelas')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label for="form-control">Unduh excel untuk import data ruang kelas kuliah</label>
                                                <a title="Unduh" href="excel/DATA IMPORT RUANG KELAS STIMIK.xlsx" target="_blank" download>
                                ...
                                <tbody>
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td class="text-center" style="display: flex; justify-content: center;">
                                            ...
                                            <a href="{{ route('ruangkelas.show', $value->uid) }}" class="btn btn-warning mb-1 mr-1 rounded-circle" data-toggle="tooltip" title='Update'><i class="bx bx-edit bx-sm"></i></a>



                                            <form action="{{ route('ruangkelas.destroy', $value->uid) }}" method="post">
                                                @method('DELETE')
                                                @csrf
