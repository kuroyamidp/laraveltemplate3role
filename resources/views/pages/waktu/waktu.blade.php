                                ...
                                <tbody>
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td class="text-center" style="display: flex; justify-content: center;">
                                            ...
                                            <a href="{{ route('waktu.show', $value->uid) }}" class="btn btn-warning mb-1 mr-1 rounded-circle" data-toggle="tooltip" title='Update'><i class="bx bx-edit bx-sm"></i></a>



                                            <form action="{{ route('waktu.destroy', $value->uid) }}" method="post">
                                                @method('DELETE')
                                                @csrf
