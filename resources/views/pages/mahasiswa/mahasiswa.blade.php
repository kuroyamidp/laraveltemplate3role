            ...
            success: function(response) {
                ...
                $.each(response, function(index, value) {
                    var row = '<tr style="text-align: center;">' +
                        ...
                        '<td>' + value.kelas + '</td>' +
                        '<td>' + (value.status == 0 ? '<span class="badge badge-danger">Non aktif</span>' : (value.status == 1 ? '<span class="badge badge-primary">Aktif</span>' : '<span class="badge badge-success">Lulus</span>')) + '</td>' +
                        '<td>' + value.image + '</td>' +
                        '<td class="text-center" style="display: flex; justify-content: center;">' +
