                                            ...
                                            <td width="1%">
                                                <div class="n-chk">
                                                    <label class="new-control new-checkbox checkbox-primary">
                                                        <input type="checkbox" class="new-control-input chkJadwalSelect" jadwal-day="{{$key}}" checkbox-jadwal-id="{{$val->id}}" time-start="{{$val->matkul->start}}" time-end="{{$val->matkul->end}}" value="{{$val->id}}" name="jadwal_id[]">
